...
export async function middleware(request: NextRequest) {
  ...
  const publicRoutes = ['/login', '/register', '/', '/products', '/products/[slug]', '/about', '/contact', '/cart', '/checkout', '/orders', '/profile', '/addresses', '/payment-demo', '/payment/success', '/payment/failure']
